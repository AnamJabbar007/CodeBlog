...
const Navbar = () => {
  ...
  return (
    <nav className="p-4 z-20 bg-background/50 sticky top-0 border-b backdrop-blur">
            <LoadingBar
        color='#933ce6'
        progress={progress}
      ...
      <div className="container mx-auto flex justify-between items-center">
        <Link href={"/"}>
          <div className="text-lg font-bold">CodeBlog</div>
        </Link>
        ...
        <div className="hidden md:flex space-x-4 items-center">
          ...
          <div className="flex items-center">
            ...
            <Button className="mx-1 mr-2" variant="outline">
              Signup
            </Button>
            <ModeToggle />
          </div>
        ...
        <div className="md:hidden">
          ...
          <Sheet>
            ...
            <SheetContent>
              <SheetHeader>
                <SheetTitle className="font-bold my-4">AnamBlog</SheetTitle>
                <SheetDescription>
